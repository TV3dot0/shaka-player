  ...
  for (const drmTag of drmTags) {
    ...
    if (method != 'NONE') {
      ...
      if (drmInfo) {
        ...
        console.log('Unsupported HLS KEYFORMAT', keyFormat);
      }
    }
  }
...
shaka.hls.HlsParser.prototype.fetchPartialSegment_ = async function(reference) {
  ...
  console.log('[hls] part', reference.getUris());
  ...
  console.log('[hls] full', reference.getUris());
...
/**
 * used to make valid HLS clearkey tag KEYFORMAT="identity"
 *
 * @param {!shaka.hls.Tag} drmTag
 * @return {?shaka.extern.DrmInfo}
 * @private
 */
shaka.hls.HlsParser.clearKeyDrmParser_ = function(drmTag) {
  console.log('using identity clearkey parser');
...
shaka.hls.HlsParser.KEYFORMATS_TO_DRM_PARSERS_ = {
  ...
  */
  ...
  'identity':
      shaka.hls.HlsParser.clearKeyDrmParser_,
};
