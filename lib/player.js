...
shaka.Player.prototype.onInitializeDrm_ = async function(has, wants) {
  ...
  this.manifest_.persistedSessions = new Map(Object.entries(this.config_.drm.persistedSessions)) || new Map();
...
shaka.Player.prototype.getPersistentSessions = function() {
  return this.drmEngine_ ? this.drmEngine_.getPersistentSessions() : new Map();
};
